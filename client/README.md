...
React + Vite (JavaScript) web app. Current scope: the authentication experience and the organization area (asset inventory, members, invitations, settings, switching), backed by the real API in `../server`.
...
`/invite?token=…`, `/organization/assets` (`/new`, `/:id`, `/:id/edit`), `/organization/members`,
...
- Asset API client: `src/services/assets/assetApi.js`. Docs: `docs/assets/README.md`.
