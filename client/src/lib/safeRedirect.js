 ...
 */
const ALLOWED = [/^\/invite\?token=[A-Za-z0-9_-]{1,512}$/, /^\/organization(\/(members|settings|software|matches(\/[a-f0-9]{24})?|vulnerabilities(\/(nvd|osv)\/[A-Za-z0-9._:-]{1,64})?|assets(\/new|\/[a-f0-9]{24}(\/edit)?)?))?$/]
